...
type ServerInterface interface {
	...
	// Delete a task
	// (DELETE /tasks/{id})
	DeleteTasksId(ctx echo.Context, id openapi_types.UUID) error
	// Update a task
	// (PATCH /tasks/{id})
	PatchTasksId(ctx echo.Context, id openapi_types.UUID) error
}
...
func (sh *strictHandler) DeleteTasksId(ctx echo.Context, id openapi_types.UUID) error {
...
func (sh *strictHandler) PatchTasksId(ctx echo.Context, id openapi_types.UUID) error {
